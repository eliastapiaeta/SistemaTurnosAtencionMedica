...
namespace Turnos.Controllers
{
    public class MedicoController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            {
                ViewData["ListaEspecialidades"] = new SelectList(
                    _context.Especialidad, "IdEspecialidad", "Descripcion", medico.MedicoEspecialidad
                );
            }
        ...
        public string TraerHorarioAtencionDesde(int idMedico)
        {
            ...
            var timeOfDay = HorarioAtencionDesde.TimeOfDay;
        ...
        public string TraerHorarioAtencionHasta(int idMedico)
        {
            ...
            var timeOfDay = HorarioAtencionHasta.TimeOfDay;
